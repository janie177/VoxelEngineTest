...
public class TerrainShader extends Shader {
	...
	private static final String vertexFile = Options.SHADERS_PATH + "terrainVertexShader.txt";
	private static final String fragmentFile = Options.SHADERS_PATH + "terrainFragmentShader.txt";
